...
/**
 * Default role-management service implementation.
 *
 * <p>Roles provide high-level access boundaries while their assigned
 * permissions provide operation-level authorization.</p>
 *
